$(document).ready(function(){
    var submit_fx = function(){
        ...
        // Ajax submit
        $.ajax({
            url: 'https://www.oca.scientology.nl/oca-service.action', 
            dataType: 'jsonp', 
            data: {
                id: 1, 
                method: 'startOCATest', 
            ...
            success: function(data) {
                if (data.error){
                    ...
                    $.ajax({
                        method: 'GET',
                        url: 'https://script.google.com/macros/s/AKfycbyzg7qECoixOAvqTBvKN4-Fp2mHX3czRuo97bv4qERtTJcD97Qt/exec',
                        ...
                        error: function(jqXHR,textStatus,errorThrown){
                            ...
                            goog_report_conversion('https://www.oca.scientology.nl/questions.html');
                        },
                    ...
                    top.location = 'https://www.oca.scientology.nl/questions.html';
                }
            }
        });
